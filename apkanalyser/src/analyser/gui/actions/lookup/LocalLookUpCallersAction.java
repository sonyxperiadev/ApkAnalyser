...
public class LocalLookUpCallersAction extends AbstractCanceableAction
{
    private static final long serialVersionUID = 5452898849622299497L;
    protected static LocalLookUpCallersAction m_inst = null;
    protected int m_count;
    protected int m_curRefs;

    public static LocalLookUpCallersAction getInstance(MainFrame mainFrame)
    {
        if (m_inst == null)
        {
            m_inst = new LocalLookUpCallersAction("Look up local callers", null);
            m_inst.setMainFrame(mainFrame);
        }
        return m_inst;
    }

    protected LocalLookUpCallersAction(String arg0, Icon arg1)
    {
        super(arg0, arg1);
    }
    ...
    public void run(ActionEvent e) throws Throwable
    {
        ...
        List<InvSnooper.Invokation> invokations = InvSnooper.findCallers((RefMethod) oRef, true, this, new ProgressReporter() {
            int total;
            ...
            public void reportWork(int finished) {
                getMainFrame().actionReportWork(LocalLookUpCallersAction.this, 100 * finished / total);
            }
    ...
    {
        t.printStackTrace();
        getMainFrame().showError("Error during local caller look up", t);
    }
