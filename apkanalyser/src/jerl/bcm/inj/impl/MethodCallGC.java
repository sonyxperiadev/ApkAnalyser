...
public class MethodCallGC extends InjectionMethodCall {

    public MethodCallGC(String signature, String callSignature, boolean pre) {
        super(signature, callSignature, pre);
    }

    @Override
    public void inject(MethodVisitor mv) {
        new InjectCollection().injectGC(mv);
    }
