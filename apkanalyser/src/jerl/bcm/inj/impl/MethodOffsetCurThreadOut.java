...
public class MethodOffsetCurThreadOut extends InjectionMethodOffset {
    private final String str;

    public MethodOffsetCurThreadOut(String signature, int offset, String str) {
    ...
    public void inject(MethodVisitor mv) {
        new InjectCollection().injectSystemOutCurThread(mv, str);
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            MethodOffsetCurThreadOut moo = (MethodOffsetCurThreadOut) o;
