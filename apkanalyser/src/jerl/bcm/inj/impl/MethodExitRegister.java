...
public class MethodExitRegister extends InjectionMethodExit {
    private final int id;

    public MethodExitRegister(String signature, int id) {
        super(signature);
        this.id = id;
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            MethodExitRegister mer = (MethodExitRegister) o;
