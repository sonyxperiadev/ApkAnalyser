...
public class MethodOffsetRegister extends InjectionMethodOffset {
    private final int id;

    public MethodOffsetRegister(String signature, int offset, int id) {
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            MethodOffsetRegister mor = (MethodOffsetRegister) o;
            return getID() == mor.getID();
        } else {
            return false;
        }
    }
