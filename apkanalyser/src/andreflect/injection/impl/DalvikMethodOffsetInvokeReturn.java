...
public class DalvikMethodOffsetInvokeReturn extends DalvikInjectionMethodOffset {
    private final String str;
    Instruction invokeIns = null;
    Instruction moveResultIns = null;

    public DalvikMethodOffsetInvokeReturn(String signature, Instruction ins, String str) {
        super(signature, ins);
        this.str = str;
    }
    ...
    public ArrayList<Instruction> injectDalvik(DalvikInjectCollection dic, DexMethod method, Instruction ins) {
        ...
        return dic.injectInvokeReturn(method, Util.appendCodeAddressAndLineNum(str, invokeIns), invokeIns, moveResultIns, ins, methodIdItem);
    }

    public void setInvokeIns(Instruction ins) {
        invokeIns = ins;
    }

    public void setMoveResultIns(Instruction ins) {
        moveResultIns = ins;
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            DalvikMethodOffsetInvokeReturn moo = (DalvikMethodOffsetInvokeReturn) o;
