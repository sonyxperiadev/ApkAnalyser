...
public class DalvikMethodOffsetExThrow extends DalvikInjectionMethodOffset {

    private final String str;

    public DalvikMethodOffsetExThrow(String signature, Instruction ins, String str) {
        super(signature, ins);
        this.str = str;
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            DalvikMethodOffsetExThrow meo = (DalvikMethodOffsetExThrow) o;
