...
import jerl.bcm.inj.impl.InjectCollection;
...
public class DalvikMethodExitValue extends DalvikInjectionMethodExit {
    private final String str;

    public DalvikMethodExitValue(String signature, String str) {
        super(signature);
        this.str = str;
    }
    ...
    public ArrayList<Instruction> injectDalvik(DalvikInjectCollection dic, DexMethod method, Instruction ins) {
        return dic.injectReturnValue(method, Util.appendCodeAddressAndLineNum(str, ins), ins);
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            DalvikMethodExitValue meo = (DalvikMethodExitValue) o;
