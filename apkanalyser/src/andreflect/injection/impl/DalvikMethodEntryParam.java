...
public class DalvikMethodEntryParam extends DalvikInjectionMethodEntry {
    private final String str;
    private String params[];

    public DalvikMethodEntryParam(String signature, String str) {
        super(signature);
        this.str = str;
    }
    ...
    public ArrayList<Instruction> injectDalvik(DalvikInjectCollection dic, DexMethod method, Instruction ins) {
        return dic.injectParams(method, Util.appendCodeAddressAndLineNum(str, ins), params);
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            DalvikMethodEntryParam meo = (DalvikMethodEntryParam) o;
