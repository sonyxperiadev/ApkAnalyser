...
public class DalvikMethodOffsetGC extends DalvikInjectionMethodOffset {

    public DalvikMethodOffsetGC(String signature, Instruction ins) {
        super(signature, ins);
    }

    @Override
    public ArrayList<Instruction> injectDalvik(DalvikInjectCollection dic, DexMethod method, Instruction ins) {
        return dic.injectGC(method);
    }
