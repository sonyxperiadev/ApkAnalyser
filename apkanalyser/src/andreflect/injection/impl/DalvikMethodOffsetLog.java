...
public class DalvikMethodOffsetLog extends DalvikInjectionMethodOffset {
    private final String str;

    public DalvikMethodOffsetLog(String signature, Instruction instruction, String str) {
        super(signature, instruction);
        this.str = str;
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            DalvikMethodOffsetLog moo = (DalvikMethodOffsetLog) o;
