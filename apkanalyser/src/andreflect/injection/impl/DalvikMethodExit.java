...
public class DalvikMethodExit extends DalvikInjectionMethodExit {
    private final String str;

    public DalvikMethodExit(String signature, String str) {
        super(signature);
        this.str = str;
    }
    ...
    public boolean equals(Object o) {
        if (super.equals(o)) {
            DalvikMethodExit meo = (DalvikMethodExit) o;
