...
public class DalvikMethodLocalReadAction extends AbstractTreeBytecodeModAction {

    private static final long serialVersionUID = 476221274688224208L;
    protected static DalvikMethodLocalReadAction m_inst = null;

    public static DalvikMethodLocalReadAction getInstance(MainFrame mainFrame)
    {
        if (m_inst == null)
        {
            m_inst = new DalvikMethodLocalReadAction("Print reading local variables", null);
            m_inst.setMainFrame(mainFrame);
        }
        return m_inst;
    }

    protected DalvikMethodLocalReadAction(String arg0, Icon arg1)
    {
        super(arg0, arg1);
    }
