...
public class DalvikMethodOffsetSyncExitAction extends AbstractTreeBytecodeModAction {

    private static final long serialVersionUID = 573209937555854730L;
    protected static DalvikMethodOffsetSyncExitAction m_inst = null;

    public static DalvikMethodOffsetSyncExitAction getInstance(MainFrame mainFrame)
    {
        if (m_inst == null)
        {
            m_inst = new DalvikMethodOffsetSyncExitAction("Print synchronized exit", null);
            m_inst.setMainFrame(mainFrame);
        }
        return m_inst;
    }

    protected DalvikMethodOffsetSyncExitAction(String arg0, Icon arg1)
    {
        super(arg0, arg1);
    }
